...
public class Main {
    public static void main(String[] args){
        ...
        for(int i = 0; i<5; i++){
            System.out.println(N.getSpecificRowSequence(i));
            System.out.println(Arrays.toString(N.getRow(i)));
            System.out.println(N.getSpecificColSequence(i));
            System.out.println(Arrays.toString(N.getCol(i)));
        }
        System.out.println();
